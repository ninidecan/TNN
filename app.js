...
const WARDS = [
  { id: 'W1', name: 'ICU1', groupId: 'G1' }, { id: 'W2', name: 'ICU2', groupId: 'G1' },
  { id: 'W3', name: 'CCU', groupId: 'G1' }, { id: 'W4', name: 'OR1', groupId: 'G2' },
  { id: 'W5', name: 'OR2', groupId: 'G2' }, { id: 'W6', name: 'RR', groupId: 'G2' },
  { id: 'W7', name: 'ER', groupId: 'G3' }, { id: 'W8', name: 'Trauma', groupId: 'G3' },
  { id: 'W9', name: 'LR', groupId: 'G4' }, { id: 'W10', name: 'PP', groupId: 'G4' },
  { id: 'W11', name: 'Med1', groupId: 'G5' }, { id: 'W12', name: 'Med2', groupId: 'G5' },
  { id: 'W13', name: 'Surg1', groupId: 'G6' }, { id: 'W14', name: 'Surg2', groupId: 'G6' },
  { id: 'W15', name: 'Ped1', groupId: 'G7' }, { id: 'W16', name: 'OPD', groupId: 'G8' }
];

const SPECIALTY_COURSES_4MONTH = ['การพยาบาลผู้ป่วยวิกฤต (ผู้ใหญ่)','การพยาบาลผู้ป่วยวิกฤต (เด็ก)','การพยาบาลเวชปฏิบัติฉุกเฉิน','การพยาบาลผู้ป่วยโรคหัวใจและหลอดเลือด','การพยาบาลผู้ป่วยมะเร็ง','การพยาบาลผู้ป่วยโรคไต','การพยาบาลผู้ป่วยศัลยกรรมอุบัติเหตุ','การพยาบาลผู้ป่วยทารกแรกเกิด','การผดุงครรภ์','การพยาบาลเวชปฏิบัติทั่วไป','การพยาบาลผู้สูงอายุ','การพยาบาลจิตเวชและสุขภาพจิต','การพยาบาลบริหาร/การจัดการ'];
const SHORT_COURSES = ['ACLS Provider','BLS Provider','PALS Provider','Trauma Nursing','Wound Care','IV Therapy','Pain Management','Palliative Care','Infection Control','Quality Improvement'];
const GRADUATE_COURSES = ['พยาบาลศาสตรมหาบัณฑิต (การพยาบาลผู้ใหญ่)','พยาบาลศาสตรมหาบัณฑิต (การพยาบาลเด็ก)','พยาบาลศาสตรมหาบัณฑิต (การพยาบาลผู้สูงอายุ)','พยาบาลศาสตรมหาบัณฑิต (การบริหารการพยาบาล)','สาธารณสุขศาสตรมหาบัณฑิต','พยาบาลศาสตรดุษฎีบัณฑิต'];
const PRACTICAL_COURSES = ['หลักสูตรประกาศนียบัตรผู้ช่วยพยาบาล (1 ปี)','หลักสูตรผู้ช่วยพยาบาล (6 เดือน)'];
